                ...
                <a href="index.php?page=order_detail&order_code=<?php echo $order['order_code']; ?>">
                    <div class="order__item">
                        ...
                        <div class="order__container">
                            ...
                            while ($od = mysqli_fetch_array($query_order_detail_list)) {
                                $final_price = (float)$od['product_price'] - ((float)$od['product_price'] * (float)$od['product_sale'] / 100);
                                if ($final_price < 0) {
                                    $final_price = 0;
                                }
                            ?>
                                <div class="cart__item d-flex align-center">
                                    <div class="cart__image p-relative">
                                        <img
                                            class="w-100 d-block object-fit-cover ratio-1"
                                            src="admin/modules/product/uploads/<?php echo htmlspecialchars($od['product_image'], ENT_QUOTES, 'UTF-8'); ?>"
                                            alt="product"
                                        />
                                    </div>
                                    ...
                                    <div class="flex-1">
                                        <h3 class="cart__name h4">
                                            <?php echo htmlspecialchars($od['product_name'], ENT_QUOTES, 'UTF-8'); ?>
                                        </h3>
                                        <span class="cart__quantity h6 d-block">
                                            x <?php echo (int)$od['product_quantity']; ?>
                                        </span>
                                    </div>
