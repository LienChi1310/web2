                ...
                <div class="row">
                    <div class="col">
                        <div class="article__img--item">
                            <img class="w-100 d-block object-fit-cover" src="admin/modules/blog/uploads/<?php echo $row['article_image'] ?>" alt="image article" onerror="this.src='./assets/images/product/product-image.jpg'">
                        </div>
                    </div>
                </div>
            </div>
