...
<script>
  (function() {
    ...
    (function() {
      ...
      p.set('page', 'products');
      <?php if ($category_id): ?>p.set('category_id', '<?php echo $category_id; ?>');
      <?php else: ?>p.delete('category_id');
    <?php endif; ?>
    <?php if ($brand_id): ?>p.set('brand_id', '<?php echo $brand_id; ?>');
    <?php else: ?>p.delete('brand_id');
    <?php endif; ?>
    <?php if ($dirParam): ?>p.set('pricesort', '<?php echo $dirParam; ?>');
    <?php else: ?>p.delete('pricesort');
    <?php endif; ?>
    if (<?php echo $price_from; ?> === DEF_MIN && <?php echo $price_to; ?> === DEF_MAX) {
      p.delete('pricefrom');
      p.delete('priceto');
    } else {
      p.set('pricefrom', '<?php echo $price_from; ?>');
      p.set('priceto', '<?php echo $price_to; ?>');
    }
