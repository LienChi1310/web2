...
<div class="row" style="margin-bottom: 10px;">
    <div class="col d-flex" style="justify-content: space-between; align-items: flex-end;">
        ...
        <a href="index.php?action=inventory&query=inventory_detail&inventory_id=<?php echo $inventory_id; ?>" class="btn btn-outline-dark btn-fw">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div>
                                    <span style="color: #999; font-size: 12px; margin-right: 10px;">
                                        ...
                                        <span class="<?php echo inventory_status_class($row_inventory['inventory_status']); ?> px-2 py-1 rounded" style="font-size: 11px;">
                                    ...
                                    <tbody id="inventory-body">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" name="price_import[]" class="form-control text-center"
